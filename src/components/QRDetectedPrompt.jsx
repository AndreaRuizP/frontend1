    ...
    return (
        <div className="bg-white dark:bg-slate-900 rounded-3xl shadow-sm border border-[#E0E5EB] dark:border-slate-800 p-5 lg:p-6 transition-colors duration-300">
            <div className="flex items-start justify-between gap-4 mb-4">
                <div>
                    <p className="text-xs font-bold uppercase tracking-[0.2em] text-green-600 dark:text-green-400">Siguiente Paso</p>
                ...
                <div className="hidden sm:flex w-12 h-12 rounded-2xl bg-green-50 dark:bg-green-950/40 border border-green-100 dark:border-green-900/30 items-center justify-center shrink-0">
                    <i className="bi bi-camera text-2xl text-green-600 dark:text-green-400"></i>
                </div>
            </div>
            ...
            <div className="rounded-3xl border border-dashed border-[#C9D3DD] dark:border-slate-700 bg-[#f8fafc] dark:bg-slate-950/40 px-5 py-8 lg:py-10 flex flex-col items-center text-center transition-colors duration-300">
                <div className="w-20 h-20 rounded-full bg-white dark:bg-slate-900 border border-green-100 dark:border-green-800 shadow-sm flex items-center justify-center mb-4">
                    <i className="bi bi-camera text-4xl text-green-600 dark:text-green-400"></i>
                </div>
                ...
                <button
                    ...
                    className="mt-5 inline-flex items-center gap-2 rounded-xl bg-green-600 dark:bg-green-500 px-5 py-3 text-sm font-bold text-white shadow-sm transition hover:bg-green-700 dark:hover:bg-green-600 active:scale-95 focus:outline-none"
                    style={{ minHeight: 44 }}
                >
