...
export default function Home() {
  return (
    <main className="w-full min-h-[calc(100vh-60px)] flex flex-col items-center bg-white dark:bg-slate-950 transition-colors duration-300">
      <Header />
        ...
        <div className="w-full max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-14 lg:py-16">
          <div className="grid items-center gap-8 lg:grid-cols-2 lg:gap-12">
            <div className="max-w-2xl text-center lg:text-left">
              ...
              <p className="mx-auto lg:mx-0 mt-4 max-w-xl text-[1rem] sm:text-[1.06rem] lg:text-[1.08rem] leading-[1.65] text-slate-600 dark:text-slate-400">
      ...
      <section id="caracteristicas" className="w-full max-w-6xl mx-auto pt-10 md:pt-14 pb-8 md:pb-12 px-4 sm:px-6 lg:px-8 mb-4 md:mb-6">
        ...
        <p className="mx-auto max-w-3xl text-[0.98rem] sm:text-[1.05rem] md:text-[1.1rem] text-center text-[#666] dark:text-slate-400 leading-[1.7] px-2">
