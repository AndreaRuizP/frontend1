                        ...
                        <div className="bg-white rounded-3xl shadow-sm border border-[#E0E5EB] p-5 lg:p-6">
                            <div className="flex items-start justify-between gap-4 mb-4">
                                ...
                                <div className="hidden sm:flex w-12 h-12 rounded-2xl bg-green-50 border border-green-100 items-center justify-center shrink-0">
                                    <i className="bi bi-qr-code-scan text-2xl text-green-600"></i>
                                </div>
                            </div>
                            ...
                            {!showScanner ? (
                                <div className="rounded-3xl border border-dashed border-[#C9D3DD] bg-[#f8fafc] px-5 py-8 lg:py-10 flex flex-col items-center text-center">
                                    <div className="w-20 h-20 rounded-full bg-white border border-green-100 shadow-sm flex items-center justify-center mb-4">
                                        <i className="bi bi-qr-code-scan text-4xl text-green-600"></i>
                                    </div>
                                ...
                                <div className="flex flex-col items-center w-full">
                                    ...
                                    {scannerError && (
                                        <div className="mb-4 w-full rounded-2xl border border-red-200 bg-red-50 px-4 py-3 text-sm text-red-700">
                                            {scannerError}
                                        </div>
                                    )}
                            ...
                            {qrResult && (
                                <div className="mt-5 rounded-2xl border border-green-100 bg-green-50 px-4 py-3 flex items-center gap-3">
                                    <i className="bi bi-patch-check-fill text-green-600 text-xl shrink-0"></i>
                                    <div>
                                        <p className="font-bold text-green-800 text-sm">¡Contenedor detectado!</p>
                                        <p className="text-xs text-green-700 mt-0.5">Redirigiendo a captura de foto...</p>
                                    </div>
                                </div>
                            )}
                        </div>
